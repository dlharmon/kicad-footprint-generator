...
def generate_one_footprint(pincount, configuration):
    ...
    mpn = "B{n}B-PASK".format(n=str(pincount).zfill(2)) #JST part number format string
    ...
    # latch
    kicad_mod.append(RectLine(start=[x_mid-0.4,silk_y_min-0.6], end=[x_mid+0.4,silk_y_min],
        layer='F.SilkS', width=configuration['silk_line_width']))
